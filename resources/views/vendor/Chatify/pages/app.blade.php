...
<div class="messenger">
        ...
        <div class="m-body">
           ...
           <div class="messenger-tab app-scroll" data-view="search">
                ...
                <div class="search-records">
                    <p class="message-hint"><span>Taper pour rechercher...</span></p>
                </div>
             </div>
        </div>
    </div>
    ...
    <div class="messenger-messagingView">
        ...
        <div class="m-header m-header-messaging">
            <nav>
                ...
                <nav class="m-header-right">
                    ...
                    <a href="{{ url('/f') }}"><i class="fas fa-home"></i></a>
        ...
        <div class="m-body app-scroll">
            <div class="messages">
                <p class="message-hint" style="margin-top: calc(30% - 126.2px);"><span>Sélectionner une conversation pour commencer à discuter !</span></p>
            </div>
            {{-- Typing indicator --}}
